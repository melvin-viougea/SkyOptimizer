...
const ProgressionRender: FC<RenderProps> = ({profileData}) => {
  ...
  return (
    <div className="rounded-3xl bg-gray-800 text-gray-200 p-8 m-5 shadow-lg">
      ...
      {/*<div*/}
      {/*  className={`${*/}
      {/*    profileData.playerTotalNetworth >= 100_000_000 ? "bg-gray-300" : "bg-red-400"*/}
      ...
      {/*/!*<div*!/*/}
      {/*/!*  className={`${*!/*/}
      {/*/!*    profileData.item?.hyperion ? "bg-gray-300" : "bg-red-400"*!/*/}
      {/*/!*  } text-gray-800 rounded-lg p-5 w-1/2 mx-auto text-center mt-5`}*!/*/}
      {/*/!*>*!/*/}
      ...
      {/*<div*/}
      {/*  className={`${*/}
      {/*    profileData.playerTotalNetworth >= 6_000_000_000 ? "bg-gray-300" : "bg-red-400"*/}
      {/*  } text-gray-800 rounded-lg p-5 w-1/2 mx-auto text-center mt-5`}*/}
      {/*>*/}
      ...
      {/*<div*/}
      {/*  className={`${*/}
      {/*    profileData.playerTotalNetworth >= 15_000_000_000 ? "bg-gray-300" : "bg-red-400"*/}
      {/*  } text-gray-800 rounded-lg p-5 w-1/2 mx-auto text-center mt-5`}*/}
      {/*>*/}
      ...
      <div className="bg-gray-300 text-gray-800 rounded-lg p-5 w-1/2 mx-auto text-center mt-5">
        <h2 className="text-xl font-bold">5 : Atteindre 12.076.732 de gemstone powder</h2>
      </div>
      ...
      <div className="bg-gray-300 text-gray-800 rounded-lg p-5 w-1/2 mx-auto text-center mt-5">
        <h2 className="text-xl font-bold">7 : Atteindre 3.966.926 de Mithril Powder (retirer 93.838 si vous ne voulez pas la perks Quick Forge de montée)</h2>
      </div>
