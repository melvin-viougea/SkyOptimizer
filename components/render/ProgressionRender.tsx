...
const ProgressionRender: FC<RenderProps> = ({ profileData }) => {
  ...
  return (
    <div className="rounded-3xl bg-primary text-gray-200 p-8 m-5 shadow-lg">
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(1) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(1)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(2) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(2)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(3) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(3)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(4) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(4)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(5) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(5)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(6) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(6)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(7) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(7)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(8) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(8)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(9) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(9)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(10) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(10)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(11) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(11)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(12) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(12)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(13) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(13)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(14) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(14)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(15) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(15)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(16) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(16)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(17) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(17)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(18) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(18)}>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6 ${isStepSelected(19) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(19)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(20) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(20)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">2</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(21) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(21)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(22) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(22)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(23) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(23)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(24) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(24)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">6</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(25) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(25)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">7</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(26) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(26)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">8</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(27) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(27)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">9</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(28) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(28)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">10</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(29) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(29)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">11</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(30) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(30)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">12</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(31) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(31)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">13</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(32) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(32)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">14</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(33) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(33)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">15</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(34) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(34)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">16</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(35) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(35)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">17</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6 ${isStepSelected(36) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(36)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(37) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(37)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">2</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(38) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(38)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(39) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(39)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(40) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(40)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6 ${isStepSelected(41) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(41)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(42) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(42)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">2</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(43) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(43)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(44) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(44)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(45) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(45)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(46) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(46)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">6</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(47) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(47)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">7</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(48) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(48)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">8</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(49) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(49)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(50) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(50)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">2</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(51) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(51)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(52) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(52)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center ${isStepSelected(53) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(53)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
      ...
      <div className={`bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6 ${isStepSelected(54) ? 'bg-green-500 outline outline-2 outline-green-500' : ''}`} onClick={() => handleClick(54)}>
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
