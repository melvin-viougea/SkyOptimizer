  ...
  return (
    <div className="rounded-3xl bg-primary text-gray-200 p-8 m-5 shadow-lg">
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire les quêtes de l'île</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire les quêtes des 12 PNJ et récupérer la <a href="https://wiki.hypixel.net/Rogue_Sword" className="text-raritycommon underline underline-offset-4" target="_blank" rel="noopener noreferrer">ROGUE SWORD</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire les quêtes du bûcheron (-112 74 -36) dans le Hub</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire les quêtes mineur du Blacksmith (-28 69 -125)dans le Hub jusqu'aux Deep Caverns</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller au Spider's Den pour parler au PNJ bestiaire (-271 113 -196)</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire les quêtes du fermier (44 72 -162) dans le Hub jusqu'à débloquer le Mushroom Desert</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller sur l'île Barn et compléter le bestiaire de l'île</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller chercher la <a href="https://wiki.hypixel.net/Squire_Armor" className="text-rarityuncommon underline underline-offset-4" target="_blank" rel="noopener noreferrer">SQUIRE ARMOR</a> à Rosetta (-12 68 -141) dans le Hub</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Continuer les quêtes Deep Caverns jusqu'à la zone Redstone</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Monter la collection Redstone 2 pour débloquer le sac d'accessoires</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller chercher les talismans a l'aventurier (-41 70 -64) face du PNJ Bazaar</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire la quête du Redstone Miner (24 104 16) dans les Deep Caverns</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Récupérer assez de Redstone pour fabriquer 5 minions niveau 4 puis les placer sur son île</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Finir de descendre dans les Deep Caverns en terminant les quêtes</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller chercher la <a href="https://wiki.hypixel.net/Promising_Shovel" className="text-rarityuncommon underline underline-offset-4" target="_blank" rel="noopener noreferrer">PROMISING SHOVEL</a> à Rick (-251 70 -325) dans le Spider's Den</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller dans le Mushroom Desert pour farmer le sable et passer Mining niveau 12</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        ...
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Débloquer l'accès aux Dwarven Mines</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Accéder aux Dwarven Mines</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Aller tuer des Glacite Walker au Great Ice Wall (0 128 150) pour récupérer la <a href="https://hypixel-skyblock.fandom.com/wiki/Glacite_Armor" className="text-rarityepic underline underline-offset-4" target="_blank" rel="noopener noreferrer">GLACITE ARMOR</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Pensez au Daily, Puzzler (181 196 135) et Fetchur (84 224 -118) pour gagner un peu de powder et d'argent</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Passer HOTM 2</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">6</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Utiliser la forge dès que possible (au minimum craft des Refined Mithril)</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">7</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Farmer les Glacite Jewels jusqu'à pouvoir acheter le <a href="https://wiki.hypixel.net/Mithril_Golem_Pet" className="text-raritylegendary underline underline-offset-4" target="_blank" rel="noopener noreferrer">MITHRIL GOLEM</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">8</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger les <a href="https://wiki.hypixel.net/Mithril_Equipment" className="text-rarityuncommon underline underline-offset-4" target="_blank" rel="noopener noreferrer">MITHRIL EQUIPMENT</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">9</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Passer HOTM 4 via les commissions et event</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">10</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter la <a href="https://wiki.hypixel.net/Sorrow_Armor" className="text-raritylegendary underline underline-offset-4" target="_blank" rel="noopener noreferrer">SORROW ARMOR</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">11</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger les <a href="https://wiki.hypixel.net/Titanium_Equipment" className="text-rarityrare underline underline-offset-4" target="_blank" rel="noopener noreferrer">TITANIUM EQUIPMENT</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">12</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">HOTM 5, réinitialiser l'arbre dès que <span className="text-powdermithril">150.000 mithril powder</span> atteint pour débloquer un commission slot avec le Core lvl 2</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">13</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger la <a href="https://wiki.hypixel.net/Mithril_Drill_SX-R326" className="text-rarityrare underline underline-offset-4" target="_blank" rel="noopener noreferrer">MITHRIL DRILL SX-R326</a> dès que possible</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">14</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger la <a href="https://wiki.hypixel.net/Spicy_Goblin_Omelette" className="text-rarityrare underline underline-offset-4" target="_blank" rel="noopener noreferrer">SPICY GOBLIN OMELETTE</a> et le mettre sur la drill</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">15</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger le <a href="https://wiki.hypixel.net/Mithril-Infused_Fuel_Tank" className="text-rarityrare underline underline-offset-4" target="_blank" rel="noopener noreferrer">MITHRIL-INFUSED FUEL TANK</a> et le mettre sur la drill</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">16</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter/forger le <a href="https://wiki.hypixel.net/Mithril-Plated_Drill_Engine" className="text-rarityrare underline underline-offset-4" target="_blank" rel="noopener noreferrer">MITHRIL-PLATED DRILL ENGINE</a> et le mettre sur la drill</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">17</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Passer HOTM 7</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter la <a href="https://wiki.hypixel.net/Mineral_Armor" className="text-rarityepic underline underline-offset-4" target="_blank" rel="noopener noreferrer">MINERAL ARMOR</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">2</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Acheter un <a href="https://wiki.hypixel.net/Armadillo_Pet" className="text-raritylegendary underline underline-offset-4" target="_blank" rel="noopener noreferrer">ARMADILLO</a></h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">3</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Dès que possible, acheter/forger une <a href="https://wiki.hypixel.net/Jasper_Drill_X" className="text-rarityepic underline underline-offset-4" target="_blank" rel="noopener noreferrer">JASPER DRILL X</a> et y mettre les Drill Parts achetés précédemment</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">4</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Faire la powder avec l'ouverture des Treasure Chest dans Precursor City pour faire de l'argent</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">5</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Atteindre <span className="text-powdergemstone">12.076.732 gemstone powder</span> (minimum nécessaire gemstone mining)</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">Armor : <a href="https://wiki.hypixel.net/Armor_Of_Divan" className="text-raritylegendary underline underline-offset-4" target="_blank" rel="noopener noreferrer">ARMOR OF DIVAN</a> jaded - recomb - full perfect - amélioration non obligatoire : wisdom</h2>
      </div>
      ...
      <div className="bg-yellow text-gray-300 rounded-lg w-1/2 mx-auto flex items-center mt-6">
        <span className="text-xl font-bold text-center text-gray-800 flex items-center justify-center rounded-l-lg w-14">1</span>
        <h2 className="bg-secondary text-xl font-bold text-center flex-1 p-5 h-full">WIP</h2>
      </div>
