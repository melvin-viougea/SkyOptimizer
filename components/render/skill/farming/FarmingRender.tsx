...
const FarmingRender: FC<RenderProps> = ({profileData}) => {
  ...
  const renderGamePhase = () => {
    switch (gamePhase) {
      case "early":
        return <FarmingEarlyRender profileData={profileData}/>;
      case "mid":
        return <FarmingMidRender profileData={profileData}/>;
      case "late":
        return <FarmingLateRender profileData={profileData}/>;
      case "end":
        return <FarmingEndRender profileData={profileData}/>;
      default:
        return null;
    }
  };
