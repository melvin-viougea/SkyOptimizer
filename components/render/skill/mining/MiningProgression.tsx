...
const ProgressionRender: FC<RenderProps> = ({profileData}) => {
  ...
  return (
    <div className="px-2">
      ...
      <div>
        <div className="text-gray-800 rounded-lg bg-yellow mx-auto flex items-center cursor-pointer" onClick={() => setMiningIntroduction(!miningIntroduction)}>
          ...
          <h2 className="text-xl font-bold text-center flex-1 p-5 h-full rounded-r-lg">
            {language === 'en' ?
              'Step 1 : Introduction Dwarven Mine' :
              'Étape 1 : Introduction Dwarven Mine'}
          </h2>
        </div>
        {miningIntroduction && (
          <>
      ...
      <div>
        <div className="text-gray-800 rounded-lg bg-yellow mx-auto flex items-center cursor-pointer mt-5" onClick={() => setGemstonePowder(!gemstonePowder)}>
          ...
          <h2 className="text-xl font-bold text-center flex-1 p-5 h-full rounded-r-lg">
            {language === 'en' ? 'Step 2 : Gemstone Powder' : 'Étape 2 : Gemstone Powder'}
          </h2>
        </div>
        {gemstonePowder && (
          <>
      ...
      <h2 className="text-3xl font-bold flex-1 h-full mt-10">Money Making</h2>

      <div>
        <div className="text-gray-800 rounded-lg bg-yellow mx-auto flex items-center cursor-pointer mt-5" onClick={() => setGemstoneMining(!gemstoneMining)}>
          ...
          <h2 className="text-xl font-bold text-center flex-1 p-5 h-full rounded-r-lg">
            {language === 'en' ?
              'Step 5 : GEMSTONE MINING' :
              'Étape 5 : GEMSTONE MINING'}
          </h2>
        </div>
        {gemstoneMining && (
          <>
